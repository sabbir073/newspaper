...
const SOCIAL_ICONS = [
  ...
  { name: 'X', href: 'https://x.com', color: '', svg: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/> },
  ...
  { name: 'TikTok', href: 'https://tiktok.com', color: '', svg: <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/> },
  { name: 'Threads', href: 'https://threads.net', color: '', svg: <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.59 12c.025 3.086.718 5.496 2.057 7.164 1.432 1.781 3.632 2.695 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.33-3.082.88-.76 2.119-1.207 3.583-1.291a13.853 13.853 0 0 1 3.02.142c-.126-.742-.375-1.332-.747-1.757-.513-.586-1.308-.883-2.361-.89-.002 0-.005 0-.007 0-.859 0-2.023.232-2.764 1.333l-1.753-1.161c.993-1.472 2.603-2.293 4.507-2.293l.007 0c3.202.02 5.111 1.968 5.3 5.372.109.045.216.094.322.143 1.539.734 2.666 1.836 3.284 3.202 1.035 2.324 1.033 6.1-2.236 9.339-.994.989-2.192 1.759-3.614 2.32-1.421.56-2.974.852-4.623.853zm1.647-11.212a13.022 13.022 0 0 0-.826-.025c-1.9 0-3.108.798-3.051 1.987.06 1.249 1.431 1.833 2.762 1.76 1.223-.065 2.823-.542 3.093-3.701a10.92 10.92 0 0 0-1.978-.021z"/> },
  ...
  { name: 'Snapchat', href: 'https://snapchat.com', color: '#FFFC00', svg: <path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12 1.033-.301a.33.33 0 0 1 .254-.015c.135.061.207.211.179.359-.111.586-.22 1.162-.33 1.725-.046.231-.181.39-.421.47-.18.06-.39.09-.57.12-.18.03-.36.06-.51.12-.21.09-.39.27-.39.51 0 .12.06.27.12.39.39.54.84 1.02 1.35 1.44.36.3.72.54 1.11.72.39.18.75.3 1.14.36.18.03.33.06.42.18.09.12.09.27.03.42-.21.48-.78.87-1.68 1.17-.06.03-.12.03-.18.06-.33.12-.42.3-.45.51 0 .03-.03.09-.03.12-.06.39-.18.66-.57.78-.42.12-.9.03-1.53-.18-.45-.15-.93-.21-1.44-.21-.81 0-1.38.21-1.83.45-.45.24-.84.54-1.29.87-.54.42-1.14.87-2.01 1.23-.42.18-.87.3-1.35.36-.06 0-.12 0-.18.03-.06 0-.12-.03-.18-.03-.48-.06-.93-.18-1.35-.36-.87-.36-1.47-.81-2.01-1.23-.45-.33-.84-.63-1.29-.87-.45-.24-1.02-.45-1.83-.45-.51 0-.99.06-1.44.21-.63.21-1.11.3-1.53.18-.39-.12-.51-.39-.57-.78 0-.03-.03-.09-.03-.12-.03-.21-.12-.39-.45-.51-.06-.03-.12-.03-.18-.06-.9-.3-1.47-.69-1.68-1.17-.06-.15-.06-.3.03-.42.09-.12.24-.15.42-.18.39-.06.75-.18 1.14-.36.39-.18.75-.42 1.11-.72.51-.42.96-.9 1.35-1.44.06-.12.12-.27.12-.39 0-.24-.18-.42-.39-.51-.15-.06-.33-.09-.51-.12-.18-.03-.39-.06-.57-.12-.24-.08-.375-.24-.42-.47-.11-.563-.22-1.14-.33-1.725a.323.323 0 0 1 .18-.36.321.321 0 0 1 .254.015c.374.18.733.284 1.033.3.198 0 .326-.045.401-.09-.008-.165-.018-.33-.03-.51l-.003-.06c-.104-1.628-.23-3.654.3-4.847C6.647 1.069 10.004.793 10.994.793h1.212Z"/> },
];
            ...
            <div className="lg:col-span-4 lg:border-l lg:border-border lg:pl-8">
              ...
              <div className="grid grid-cols-6 gap-2.5 mb-7">
                {SOCIAL_ICONS.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-background-tertiary transition-colors text-foreground"
              ...
              <div className="flex items-center gap-6 py-4 border-t border-border">
                ...
                <Link
                  href="/archive"
                  onClick={onClose}
                  className="flex items-center gap-2 text-base text-foreground hover:text-accent transition-colors"
                >
