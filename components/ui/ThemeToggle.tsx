...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-background-tertiary transition-colors text-foreground-muted hover:text-foreground cursor-pointer"
